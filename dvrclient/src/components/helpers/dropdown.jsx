...
const monthOptions = [ { key: '01', value: '01', text: 'January' },
...
const MonthDown = () => (
  <Dropdown id="dobMonth" closeOnChange placeholder='Month' compact search selection options={monthOptions} />
)

export default MonthDown